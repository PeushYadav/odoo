    ...
    >
      <div className="flex justify-between items-center px-6 py-4">
        ...
        <div className="flex items-center space-x-4">
          ...
          {/* 🔐 Login button */}
          <button className="hidden md:inline-block bg-blue-600 hover:bg-blue-700 text-white font-semibold py-1.5 px-4 rounded-md text-sm transition">
            Login
          </button>
      ...
      {isMenuOpen && (
        <div className="flex flex-col space-y-4 px-6 py-4 bg-white/30 dark:bg-black/40 md:hidden transition-all duration-300">
          ...
          <button className="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded-md text-sm">
            Login
          </button>
        </div>
      )}
